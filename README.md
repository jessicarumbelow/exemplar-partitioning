...
`distances` contains the centred cosine distance to each activation's nearest exemplar.
...
python -m scripts.exp_region_ablation \
    ...
    --conditions swap-c,harmful-span-c,benign-span-c,random-span \
    --holdout-centroids --n-eval 32 --max-new-tokens 256
```
